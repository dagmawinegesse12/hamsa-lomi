...
export default function ContactPage() {
  return (
    <PublicShell>
      <PageHero
        eyebrow="Contact"
        title="Reach the Hamsa Lomi office."
        body="Use the form below or reach out directly. We respond within a few business days."
      />
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-10 lg:grid-cols-[1fr_420px]">
        {/* Form */}
        <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
          <h2 className="mb-5 text-lg font-bold text-gray-950">Send a message</h2>
          <ContactForm />
        </div>
        ...
        <div className="space-y-4">
          <a
            ...
            target="_blank"
          >
            <h3 className="text-sm font-bold text-gray-950">Office location</h3>
            ...
            <p className="mt-3 text-xs font-semibold text-teal-700">View on Google Maps →</p>
          </a>
          <a
            className="block rounded-md border border-gray-200 bg-white p-5 shadow-sm hover:border-teal-300"
            href={`mailto:${publicSite.contact.email}`}
          >
            <h3 className="text-sm font-bold text-gray-950">Email</h3>
          ...
          >
            <h3 className="text-sm font-bold text-gray-950">Phone</h3>
          ...
          <div className="rounded-md border border-teal-200 bg-teal-50 p-5">
            <p className="text-sm font-bold text-teal-900">Registration windows</p>
