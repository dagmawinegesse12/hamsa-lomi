    ...
    <PublicShell>
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="mx-auto max-w-7xl px-6 py-14 pl-10">
          ...
          <h1 className="font-display mt-2 text-3xl font-bold text-ink sm:text-4xl">Tributes</h1>
          <p className="mt-3 max-w-2xl text-base leading-relaxed text-ink-muted">
            We honor the memory of our community members who have passed. May their legacy of kindness
            and connection live on through the community they helped build.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-4xl px-6 space-y-8">
          {publicSite.tributes.map((tribute) => (
            <article
              key={tribute.name}
              className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-warm"
            >
              {/* Header with photo */}
              <div className="flex items-center gap-5 border-b border-gray-100 bg-gray-50 p-6">
                ...
                <div>
                  ...
                  {tribute.dates && (
                    <p className="mt-1 text-sm text-ink-muted">{tribute.dates}</p>
                  )}
                </div>
              </div>
          ...
          <div className="rounded-xl border border-gold-200 bg-gold-50 p-6 text-center">
            ...
            <p className="mt-4 text-xs text-ink-muted max-w-lg mx-auto leading-relaxed">
              Hamsa Lomi was founded on the belief that no family should face loss alone.
              We carry our departed members in our hearts and continue their legacy through community.
            </p>
          </div>
        </div>
      </section>
