          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_380px] items-start">
            ...
            <div className="pl-4 sm:pl-6">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link
                  href={lang === "am" ? "/apply?lang=am" : "/apply"}
              ...
              <div className="p-5">
                ...
                <div className="divide-y divide-gray-100">
                  <div className="flex items-center justify-between py-4">
                    <span className="text-sm font-medium text-ink-muted">{strings[lang].about.founded}</span>
                    <span className="font-display text-lg font-bold text-ink">2014</span>
                  </div>
                  <div className="flex items-center justify-between py-4">
                    <span className="text-sm font-medium text-ink-muted">{t.membershipTitle}</span>
                    <span className="font-display text-lg font-bold text-ink">900+ members</span>
                  </div>
                  <div className="flex items-center justify-between py-4">
                    <span className="text-sm font-medium text-ink-muted">{strings[lang].membership.regFee}</span>
                    <span className="font-display text-lg font-bold text-ink">$300</span>
                  </div>
                  <div className="flex items-center justify-between py-4">
                    <span className="text-sm font-medium text-ink-muted">{strings[lang].membership.regWindows}</span>
                  ...
                  <div className="flex items-center justify-between py-4">
                    ...
                    <span className="font-display text-sm font-bold text-ink">60-mile radius</span>
                  </div>
                </div>
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-8 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-gold-600">{t.pillars}</p>
              <h2 className="font-display mt-1.5 text-2xl font-bold text-ink sm:text-3xl">
                {t.howItWorks}
              </h2>
            </div>
            <Link href={lang === "am" ? "/about?lang=am" : "/about"} className="text-sm font-semibold text-green-700 hover:text-green-800 transition-colors whitespace-nowrap">
              {t.learnMore}
            </Link>
          </div>
      ...
      <section className="bg-green-700 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-gold-400">{t.joinCommunity}</p>
              ...
              <p className="mt-2 text-sm leading-relaxed text-green-100 max-w-xl">
                {site.membership.registrationFee} {site.membership.waitingPeriod}
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href={lang === "am" ? "/membership?lang=am" : "/membership"}
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <p className="text-xs font-bold uppercase tracking-widest text-gold-600">{t.communityBoard}</p>
              </div>
              <h2 className="font-display -mt-1 text-2xl font-bold text-ink mb-5">{t.announcements}</h2>
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <p className="text-xs font-bold uppercase tracking-widest text-green-700">{t.meetingNotices}</p>
              </div>
              <h2 className="font-display -mt-1 text-2xl font-bold text-ink mb-5">{t.upcomingMeetings}</h2>
              <div className="space-y-3">
      ...
      <section className="py-14 sm:py-16 bg-green-700">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between mb-10">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-gold-400">{t.leadership}</p>
              <h2 className="font-display mt-1.5 text-2xl font-bold text-white sm:text-3xl">{t.boardMembers}</h2>
              <p className="mt-2 text-sm text-green-200">{t.currentBoard}</p>
            </div>
            <Link href={lang === "am" ? "/board?lang=am" : "/board"} className="text-sm font-semibold text-gold-400 hover:text-gold-300 transition-colors whitespace-nowrap">
              {t.viewBoard}
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between mb-8">
            <div>
              ...
              <h2 className="font-display mt-1.5 text-2xl font-bold text-ink sm:text-3xl">{t.tributes}</h2>
            </div>
            <Link href={lang === "am" ? "/tributes?lang=am" : "/tributes"} className="text-sm font-semibold text-green-700 hover:text-green-800 transition-colors whitespace-nowrap">
              {t.viewTributes}
            </Link>
          </div>
